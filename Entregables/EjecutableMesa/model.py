...
class MapaModel(Model):
    def __init__(self, N, tiempo):
        ...
        self.tiempo = tiempo  # Tiempo de Iteracion entre cambios de semaforos

        self.conductores = 0

        # Loading the dictionary from the json file.
        Diccionario = json.load(open("./Entregables/EjecutableMesa/mapDictionary.json")) # Para su visualizacion correcta, revisar que sea la ruta correcta de las imagenes.
