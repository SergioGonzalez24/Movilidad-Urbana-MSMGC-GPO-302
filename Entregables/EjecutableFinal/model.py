...
class MapaModel(Model):
    def __init__(self, N, tiempo):
        ...
        Diccionario = json.load(open("./mapDictionary.json")) # Para su visualizacion correcta, revisar que sea la ruta correcta de las imagenes.
        
        # Reading the file and creating the grid.
        with open('./2022_base.txt') as baseFile: # Para su funcionamiento correcto, revisar que sea la ruta correcta del archivo a leer.
